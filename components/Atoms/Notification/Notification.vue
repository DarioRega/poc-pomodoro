<template>
  <notification-container>
    <div
      v-if="shouldShow"
      class="w-full max-w-md rounded-lg ring-1 ring-opacity-5 shadow-lg pointer-events-auto bg-light-white dark:bg-dark-blue ring-lighter-white dark:ring-darker-blue"
    >
